      ...
      <div className="relative z-20 h-full flex flex-col px-4 pt-4 pb-2 md:px-8 md:pt-6 md:pb-4 lg:px-10 lg:pt-8 lg:pb-6">
        ...
        <div className="flex-1 flex items-center justify-center">
          <motion.div
            ...
            className="relative w-[95%] max-w-[1600px] min-h-[400px] md:min-h-[600px] px-12 py-16 md:px-32 md:py-24 rounded-[30px] overflow-hidden border border-white/10 bg-white/[0.12] backdrop-blur-[8px] shadow-[0_20px_50px_rgba(0,0,0,0.3),inset_0_0_30px_rgba(255,255,255,0.05)] ring-1 ring-white/10 flex items-center justify-center transform-gpu"
            style={{ 
              isolation: 'isolate',
