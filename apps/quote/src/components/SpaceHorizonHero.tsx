      ...
      <div className="relative z-20 h-full w-full flex items-end justify-center p-[4vw] pb-[6vh]">
        <div className="w-[92vw] max-w-[1700px] flex flex-col gap-6">
          ...
          <motion.div
            ...
            className="relative w-full min-h-[40vh] h-[65vh] md:h-[70vh] p-6 md:p-12 lg:p-20 rounded-[30px] md:rounded-[60px] overflow-hidden border border-white/10 bg-[#0A0A0F]/20 backdrop-blur-[6px] shadow-[0_40px_100px_rgba(0,0,0,0.5)] ring-1 ring-white/10 flex items-center justify-center transform-gpu"
            style={{ 
              isolation: 'isolate',
